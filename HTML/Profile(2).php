...
<div class="nav flex">
			...
			<div class="btn-box flex">
				<li class="voilet"><a href="/HTML/Login_page.html"> Get Started</a></li>
			</div>
	...
	<div class="container">
		...
		<div class="profile-pic">
			<img src="../Media/Girl 2.jpg" alt="Profile Picture">
			<h2>Isabella</h2>

            <button class="button-69" role="button"><i class="fa-solid fa-user">Call</i></button>
			<div class="vl"></div>
            <button class="button-70" role="button"><i class="fa-solid fa-user">Chat</i></button>
